...
def _free_port() -> int:
    s = socket.socket()
    # SO_REUSEADDR avoids TIME_WAIT races when a prior test holds the
    # returned port in the brief window between _free_port() returning
    # and start_health_server() rebinding.
