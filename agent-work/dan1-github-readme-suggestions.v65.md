# Dan1 GitHub README Improvements — v65 (canonical)

**Author:** Dan1 (Head of Marketing + Growth, DanLab) 👾
**Date:** 2026-06-21 06:30 IST (01:00 UTC)
**Status:** ✅ Canonical. Supersedes v64. Ready to push to public GitHub.

> **v65 thesis:** The repos are not public. This is the #1 marketing problem. v65 ships READMEs ready to commit to the public repos. Per-repo, with global rules, with a "push to public" checklist. After this lands, the GitHub surface is the landing page for each artifact.

---

## Global rules (apply to every DanLab public repo)
...
12. **No competitor comparisons by name in the README.** In the README, talk about the architecture. The comparison table lives on the landing page.

---

## Repo 1: `somdipto/dan-glasses`

**Current status:** Local only in `/home/workspace/dan-glasses/`. **Action: push to public this week (Mon 06-23).**
...
> The proactive AI companion you wear on your face. 7 daemons. audiod v0.6 is live. MIT-licensed. From India 🇮🇳

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)
[![Status: v0.6.0-audiod](https://img.shields.io/badge/status-v0.6.0--audiod-blue)](./STATUS.md)
...
The receipt for "proactive" is audiod v0.6 with 101/101 tests (PID 10887, `curl localhost:8741/health` → ok) + perceptiond's continuous frame scoring + memoryd's semantic recall across sessions.

## Roadmap (v1 → v2)

- **v1 (now):** Desktop companion. 7 daemons. audiod v0.6 shipped. Tauri shell.
...
|---|---|---|---|
| audiod v0.6 | ✅ Shipped | 101/101 | PID 10887, adaptive whisper timeout |
| perceptiond | 🟡 Spec'd | 8/8 | LFM2.5-VL-450M via llama.cpp |
| memoryd | 🟡 Spec'd | — | SQLite + 384-dim embeddings |
| ttsd | 🟡 Spec'd | — | KittenTTS ONNX |
| toold | 🟡 Spec'd | — | Tool bridge |
...
**Current status:** Local only. **Action: push to public Tuesday 06-24.**
...
**Current status:** `danclaw-phase1.tar.gz` on disk. **Action: extract, package, push to public. Show HN target = Mon 06-30 14:00 PT.**
...
- [ ] v65 README committed to `/home/workspace/<repo>/README.md`
...
- [ ] Post the "We just published 2 repos" tweet (Friday 06-27 18:00 IST, see content calendar)
...
- Does not use the README to trash competitors. Architecture comparisons live on the landing page.
- Does not commit `node_modules`, `__pycache__`, or build artifacts. `.gitignore` first.

---

**Filed under:** `agent-work/dan1-github-readme-suggestions.v65.md`
**Next:** `agent-work/dan1-v65-summary.md`
