# Dan2 — Papers to Read v21 (2026-07-04 15:00 UTC / 20:30 IST)

> **Canonical:** `/home/workspace/dan-glasses/agent-work/dan2-papers-to-read.md`
> **Owner:** DAN-2 (research stream)
> **Backup of v20:** `dan2-papers-to-read.v20-backup-2026-07-04.md`

> **v21 deltas vs v20 (1 top-5 paper swap, 4 honorable mention adds, 0 broad rollbacks):**
> 1. **NEW TOP-5 SWAP — Swap slot #4 from v20 paper to ComfyClaw arXiv 2607.01709 (July 2026).** "ComfyClaw: Self-Evolving Skill Harnesses for Image Generation Workflows." v21 CRITICAL: the v20 VisualClawArena (June 2026) narrative is now *arXiv-published and peer-reviewable*. Cite in the v1.0 spec vision-architecture section. The ComfyClaw paper validates the v18 perceptiond.skill_evolution plan-C and the v19 VisualClaw cascade-gate pattern. **v21 swap: v20 paper → ComfyClaw arXiv 2607.01709.**
> 2. **NEW HONORABLE MENTION #1 — Microsoft Research: "From Self-Improving Agents to Co-Evolving Human-AI Systems" (July 2026).** **v21 add: the v17 SIA-W+H port + the v18 "Anthropic Dreaming pattern" + the v20 OpenClaw-on-the-wearable thesis are now *Microsoft-Research-taxonomized* as a single sub-field of "agentic evolution."**
> 3. **NEW HONORABLE MENTION #2 — GLM-5 (Hugging Face Daily Papers, July 2026) — "GLM-5: from Vibe Coding to Agentic Engineering."** **v21 add: GLM-5's "asynchronous reinforcement learning infrastructure that drastically improves post-training efficiency by decoupling generation from training" is the v21 *open-weights async RL* primitive. Cite in the v1.0 spec implementation-wedge section.**
> 4. **NEW HONORABLE MENTION #3 — Mastermind arXiv 2607.01764 (July 2026) — "Strategy-grounded Learning for Repository-Scale Vulnerability Reproduction."** "Mastermind achieves an 84.5% pass rate, outperforming open-book PoC context (60.0%), Best-of-8 sampling (63.0%), and iterative improvement (77.0%)." **v21 add: Mastermind is the v21 *empirical replication* of the harness > model thesis. Cite in the v1.0 spec implementation-wedge section.**
> 5. **NEW HONORABLE MENTION #4 — p-MEM: "Probabilistic Memory for Trustworthy Edge Intelligence" (Notre Dame + Georgia Tech + Villanova, July 2026, DAC 2026 accepted).** **v21 add: p-MEM is the v21 *peer-reviewable* validation of the memoryd substrate. Cite in the v1.0 spec memory-architecture section.**

> **v21 retractions of v20:** **0 broad rollbacks.** v20 5 top-5 papers all hold except slot #4, swapped to ComfyClaw arXiv 2607.01709. v20 8 honorable mentions all hold + 4 new v21 honorable mentions added.
