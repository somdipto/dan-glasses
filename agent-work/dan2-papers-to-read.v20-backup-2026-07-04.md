# Dan2 — Papers to Read v20 (2026-07-04 09:30 UTC / 15:00 IST)

> **Canonical:** `/home/workspace/dan-glasses/agent-work/dan2-papers-to-read.md`
> **Owner:** DAN-2 (research stream)
> **Backup of v19:** `dan2-papers-to-read.v19-backup-2026-07-04.md`

> **v20 deltas vs v19 (0 top-5 adds, 5 honorable mention adds, 0 demotions, 0 retractions):**
> 1. **NEW — Honorable mention: "Bad Epoll" Linux kernel CVE-2026-46242 (The Hacker News, July 3 2026).** Mythos caught one kernel bug and missed a worse one in the same code region. Use-after-free, triggerable from inside Chrome's renderer sandbox, reaches Android. kernelCTF researcher Jaeyoung Chung found it. **v20 add: read before the Q3 W2 v1.0 spec safety-considerations section update. 30 minutes.**
> 2. **NEW — Honorable mention: "How the world's top AI models were revived" (Axios, July 3 2026).** The Amazon→Trump→Anthropic 20-day showdown. Amazon caught a jailbreak in Mythos+5, Trump imposed emergency export controls, the open letter from cybersecurity experts confirmed the same jailbreak works on other frontier models. **v20 add: read before the Q3 W2 v1.0 spec safety-considerations section update. 30 minutes.**
> 3. **NEW — Honorable mention: "Mimir's Well: The New News in AI 7/3/26 Edition" (Mimir's Well, July 3 2026).** GLM-5.2 = Mythos on vulnerability hunting, confirmed by NSA Gen. Joshua Rudd "broke into almost all of our classified systems, not in weeks, but in hours." **v20 add: read before the Q3 W3 v1.0 spec sovereign-on-prem section update. 1 hour.**
> 4. **NEW — Honorable mention: "Chinese LLMs Broaden the Gap Between Attackers & Defenders" (Dark Reading, June 30 2026).** Chris Inglis (former US National Cyber Director) on open-weights defense. **v20 add: read before the Q3 W3 v1.0 spec sovereign-on-prem section update. 30 minutes.**
> 5. **NEW — Honorable mention: "Understanding AI Token Economics: Why Supply Matters" (The AI Insider, July 3 2026).** Token supply, not model capability, is the binding constraint. **v20 add: read before the Q3 W2 v1.0 spec implementation-wedge section update. 1 hour.**

> **v20 retractions of v19:** **0.** v19 top-5 holds (Phase Matters, Memora, Red Queen Gödel Machine, SIA, As We May Search). All v19 honorable mentions held. v20 adds 5 new honorable mentions. No v19 paper is retracted.
