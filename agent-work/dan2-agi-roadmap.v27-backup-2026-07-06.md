# Dan2 — AGI Roadmap v28 (2026-07-05 10:30 UTC / 16:00 IST)

> **Canonical:** `/home/workspace/dan-glasses/agent-work/dan2-agi-roadmap.md`
> **Owner:** DAN-2 (research stream)
> **Backup of v27:** `dan2-agi-roadmap.v27-backup-2026-07-05.md` (preserved verbatim, mtime 2026-07-05 04:00 UTC)
> **Status:** v28 SHIPPED. v27 content preserved verbatim below.

> **v28 deltas vs v27 (0 plan retractions, 3 new Q3 W3 deltas, 0 retractions):**
> 1. **Q3 W3 — `perceptiond.skill_evolution` skill-selection-policy sub-component (plan-R1, NEW v28).** 1 day design spike, 1 engineer. Per Data Science Dojo (July 1 2026), skill selection is a v28 *named-bottleneck*: 196 skills available, 22% success rate with no skills, 45% success rate with proper selection. The v28 perceptiond.skill_evolution spine now requires a v28 *skill-selection-policy* sub-component before the v25 *repair-strategy* layer. **Implements the v28 Microsoft Research agentic-evolution-taxonomy *consolidation pathway* axis (select-then-update) on the v28 perceptiond side.** Pairs with plan-P1 (MemDelta gate) and plan-P2 (OKF adapter) at Q3 W3.
> 2. **Q3 W3 — `memoryd` v1.5 MHM-LRU four-head retention spike (plan-R2, NEW v28).** 1 day design spike, 1 engineer. Per arXiv 2607.01523 (Multi-Head Recurrent Memory, July 2026), MHM-LRU partitions episodic memory into independent heads and shields non-selected heads from overwriting. The v28 memoryd v1.5 three-layer model (vector + OKF + episodic) now has a v28 *fourth dimension* — MHM-LRU-style partitioned retention at the episodic layer. **Solves the v25 "long-context retention is the bottleneck" problem *architecturally*, with zero additional token overhead and no training.** Pairs with plan-P1 (MemDelta gate) and plan-P2 (OKF adapter) at Q3 W3.
> 3. **Q3 W3 — `openclaw` MCP-native + A2A-native framing (plan-R3, NEW v28).** 1 day design spike, 1 engineer. Per the v28 "HTTP for Agents" thesis (MCP for tools + A2A for inter-agent communication, cryptographically-signed Agent Cards), openclaw-as-gateway must support both. **A2A "Agent Cards" are a v28 *reversibility primitive* — every agent's identity and capabilities are signed and verifiable.** Pairs with v26 plan-O2 (reversibility contract) and v17 Hermes Agent integration.
> 4. **v28 confirms v27 v1.0 ship-gate: Q4 2026.** v28 risk-adjusted ship-gate: Q4 W3 2026 (held from v27). v27 plan-P1 (MemDelta gate) + plan-P2 (OKF adapter) all *hold*. v26 plan-O1/O2/O3 all *hold*. v25 plan-N1/N2/N3/N4 all *hold*.
> 5. **v28 6-month milestone (Q3 2026 → Q4 2026):** Q3 W1 — toold sovereign-trust audit (plan-O1) + v1.0 spec §13 sovereign-trust section (plan-O3). Q3 W2 — openclaw + toold reversibility contract (plan-O2) + 17-step narrative update + SIA concrete-numbers cite. Q3 W3 — memoryd v1.5 MemDelta-controlled-baseline gate (plan-P1) + OKF adapter spike (plan-P2) + perceptiond skill-selection-policy (plan-R1) + memoryd MHM-LRU four-head retention (plan-R2) + openclaw MCP+A2A framing (plan-R3) + Couchbase-AI-Data-Plane competitive copy. Q4 W1 — execute v1.0 ship-gate. **Risk-adjusted v28 ship-gate: Q4 W3 with v28 plan-O1+P1+P2+R1+R2+R3 all green.**
> 6. **v28 12-month milestone (Q4 2026 → Q4 2027):** v1.0 ship + v1.5 design + memoryd v1.5 OKF-backed + MHM-LRU retention + MCP+A2A-native openclaw. Target: ICML 2027 or ACL 2027 paper on v1.5 architecture (memoryd three-layer + SIA-W+H port benchmarked on LongMemEval-S with MemDelta-controlled protocol + MHM-LRU retention). Conference target unchanged from v27.
> 7. **v28 24-month milestone (Q4 2027 → Q4 2028):** v1.5 ship + v2.0 design. Target: v2.0 self-evolving wearable agent (ASPIRE-style skill library + v28 skill-selection-policy + Anthropic-Dreaming-style proposed-memory-update-with-user-approval + SIA-W+H open-weights + A2A-signed Agent Cards for inter-device collaboration). Realistic path: a v28 *first 1000-wearable fleet* validating the v28 architecture decomposition at scale, with v28 *auditable, reversible, sovereign-trust-validated, A2A-signed* agent loops in production.
> 8. **v28 risk-adjusted v1.0 ship-gate: Q4 W3 2026.** v28 risk: Redax hardware (v26 risk #1, held), toold sovereign-trust audit slip (v27 risk #1, held), MemDelta gate slip (v27 risk #2, held). v28 NEW risks: MHM-LRU integration slip (v28 risk #1), MCP+A2A framing slip (v28 risk #2). v28 mitigation: plan-R1 + plan-R2 + plan-R3 are each v28 *1-day design spikes* and can be combined with the v28 *Q3 W3 combined 5-day evaluation-and-audit spike* if engineering bandwidth is constrained.
> 9. **v28 top 5 recommendations for somdipto:** (1) **Q3 W3: `perceptiond.skill_evolution` skill-selection-policy (plan-R1, 1 day 1 engineer, *new in v28*)** — v28 launch-blocker, the v28 most-actionable signal from Data Science Dojo. (2) **Q3 W3: `memoryd` v1.5 MHM-LRU four-head retention (plan-R2, 1 day 1 engineer, *new in v28*)** — v28 architectural-alternative, training-free. (3) **Q3 W3: `openclaw` MCP-native + A2A-native framing (plan-R3, 1 day 1 engineer, *new in v28*)** — v28 protocol-standardization-validation. (4) **Q3 W1-W2: v26 plan-O1/O2/O3 + v25 plan-N1/N2/N3/N4 + v27 plan-P1/P2 still ship-gate blockers, do not slip.** (5) **Q3 W3: combined 5-day evaluation-and-audit spike (plan-R1+R2+R3+P1+P2)** if engineering bandwidth is constrained.

# Dan2 — AGI Roadmap v27 (2026-07-05 04:00 UTC / 09:30 IST)

> **Canonical:** `/home/workspace/dan-glasses/agent-work/dan2-agi-roadmap.md`
> **Owner:** DAN-2 (research stream)
> **Backup of v26:** `dan2-agi-roadmap.v26-backup-2026-07-05.md` (preserved verbatim, mtime 2026-07-05 03:07 UTC)
> **Status:** v27 SHIPPED. v26 content preserved verbatim below.

> **v27 deltas vs v26 (0 plan retractions, 2 new Q3 W3 deltas, 0 retractions):**
> 1. **Q3 W3 — memoryd v1.5 promotion-gate upgrade to MemDelta controlled-baseline protocol (plan-P1, NEW v27).** 1 day design spike, 1 engineer. The v25-v26 "beat MiniLM-RAG on retrieval quality" gate is v27 *insufficient* per MemDelta (arXiv 2606.29914): swapping only the embedding model in an identical pipeline shifts accuracy by +6.2pp; one variable flips the conclusion. The v27 memoryd v1.5 promotion gate must be v27 *MemDelta-compliant*: vary one component at a time on LongMemEval-S (500 questions, 50+ sessions, three model families) and require the candidate method to beat the v27 *controlled* baseline by a v27 *pre-registered margin* (recommend +5pp at n=500, p<0.004 per MemDelta's empirical variance). **Pair with Q3 W3 OKF adapter spike (plan-P2).**
> 2. **Q3 W3 — memoryd v1.5 OKF adapter spike (plan-P2, NEW v27).** 1 day design spike, 1 engineer. Google released Open Knowledge Format (OKF) in June 2026 as a v27 *structured-knowledge* format designed for agent memory — v27 *precision-and-structure*, not v27 *large-corpus-retrieval*. The v27 memoryd v1.5 architecture is now v27 *three-layer*: (a) vector store (MiniLM-L6-v2 today, optional Qdrant v1.5), (b) structured knowledge (OKF adapter v1.5), (c) episodic log (raw transcript + descriptions, in SQLite). The v27 framing: memoryd is the v27 *personal AI data plane* — same shape as v27 Couchbase AI Data Plane (GA June 30 2026), scoped to the user's device, auditable, reversible.
> 3. **v27 confirms v26 v1.0 ship-gate: Q4 2026.** v26 plan-O1/O2/O3 (toold sovereign-trust, openclaw reversibility, v1.0 spec §13) all *hold*. v25 plan-N1/N2/N3/N4 (toold strict-mode, openclaw shell-call audit, 16-step narrative, 6/12/24 plan revision) all *hold*. **No v26 retractions.** **No v25 retractions.**
> 4. **v27 6-month milestone (Q3 2026 → Q4 2026):** Q3 W1 — toold sovereign-trust audit (plan-O1) + v1.0 spec §13 sovereign-trust section (plan-O3). Q3 W2 — openclaw + toold reversibility contract (plan-O2) + 17-step narrative update + SIA concrete-numbers cite. Q3 W3 — memoryd v1.5 MemDelta-controlled-baseline gate (plan-P1) + OKF adapter spike (plan-P2) + Couchbase-AI-Data-Plane competitive copy. Q4 W1 — execute v1.0 ship-gate. **Risk-adjusted v27 ship-gate: Q4 W3 with v27 plan-O1+P1+P2 all green.**
> 5. **v27 12-month milestone (Q4 2026 → Q4 2027):** v1.0 ship + v1.5 design + memoryd v1.5 OKF-backed. Target: ICML 2027 or ACL 2027 paper on v1.5 architecture (memoryd three-layer + SIA-W+H port benchmarked on LongMemEval-S with MemDelta-controlled protocol). Conference target unchanged from v26.
> 6. **v27 24-month milestone (Q4 2027 → Q4 2028):** v1.5 ship + v2.0 design. Target: v2.0 self-evolving wearable agent (ASPIRE-style skill library + Anthropic-Dreaming-style proposed-memory-update-with-user-approval + SIA-W+H open-weights). Realistic path: a v27 *first 1000-wearable fleet* validating the v27 architecture decomposition at scale, with v27 *auditable, reversible, sovereign-trust-validated* agent loops in production.
> 7. **v27 risk-adjusted v1.0 ship-gate: Q4 W3 2026.** v27 risk: Redax hardware (v26 risk #1, held), toold sovereign-trust audit slip (v27 risk #1, NEW), MemDelta gate slip (v27 risk #2, NEW). v27 mitigation: 1-day plan-O1 + 1-day plan-P1 can be combined into a v27 *combined 2-day evaluation-and-audit spike* Q3 W3 if engineering bandwidth is constrained.

# Dan2 — AGI Roadmap v26 (2026-07-05 09:00 UTC / 14:30 IST)

> **Canonical:** `/home/workspace/dan-glasses/agent-work/dan2-agi-roadmap.md`
> **Owner:** DAN-2 (research stream)
> **Backup of v25:** `dan2-agi-roadmap.v25-backup-2026-07-05.md` (59KB, 387 lines)
> **Status:** v26 SHIPPED. v25 content preserved verbatim below.

> **v26 deltas vs v25 (2 NEW LAUNCH-BLOCKER upgrades, 3 CRITICAL adds, 0 broad rollbacks, 3 v1.0 plan adds, 0 v1.5 plan adds, 6/12/24-month plan revision reflecting v26 sovereign-trust + reversibility + bifurcation):**
> 1. **NEW LAUNCH-BLOCKER UPGRADE #1 — `toold` sovereign-trust audit (plan-O1).** v26 extends the v24 launch-blocker to also include v26 *sovereign-trust* test cases: an OCR-derived command that contains the v26 Adversa shell-trick class must be rejected. 1-day spike, 1 engineer, target Q3 W1.
> 2. **NEW LAUNCH-BLOCKER UPGRADE #2 — `openclaw` + `toold` end-to-end reversibility contract (plan-O2).** v26 adds a v26 `revert_loop(loop_id)` API to openclaw that drops the loop's effects from memoryd, undoes any toold side effects, and logs the revert. 3-day spike, 1 engineer, target Q3 W2. Pairs with the v8 Anthropic-Dreaming *proposed-memory-update-with-user-approval* pattern.
> 3. **NEW CRITICAL #1 — Alibaba-Claude-Code-ban (GIGAZINE + Reuters + South China Morning Post, July 4 2026).** v26 launches a v26 *three-region-bifurcation* framing of the 2026 AGI landscape: (a) U.S. defense → open-weights (Nemotron, Karp-migration-claim), (b) China → sovereign (Alibaba ban, Anthropic export ban), (c) Europe → Mistral/Forge (Mensch LinkedIn post). v26 implication: Dan Glasses open-weights + on-device architecture is the v26 *only* posture that is politically-uncapturable across all three regions.
> 4. **NEW CRITICAL #2 — Trump-lifts-Mythos-Fable-export-ban (AOL + Anthropic X, July 1-2 2026).** v26 partial retraction of v25 "Anthropic Mythos is gated, $30K catch" claim: Fable 5 is now globally available (July 1) and Mythos 5 is broadened to a larger set of US critical-infrastructure partners (July 4). v26 implication: closed-source frontier model access is *politically-conditional*, not export-controlled. v26 wedge sharpens: Dan Glasses open-weights are politically-uncapturable.
> 5. **NEW CRITICAL #3 — xAI Babushkin reversibility warning (BitRebels + Let's Data Science, July 2026).** v26 launches a v26 *reversibility* framing: the user's ability to revert the agent loop is the v26 *most-important* safety property. v26 implication: the v26 `revert_loop(loop_id)` API is the v26 *minimum-viable reversibility* primitive.
> 6. **v26 v1.0 plan adds (3):**
>     - **(1) `toold` sovereign-trust audit (plan-O1)** — 1 day 1 engineer, target Q3 W1.
...
> 7. **v26 6/12/24-month plan revision (v25 6/12/24 plan holds, v26 adds 3 Q3 deltas):**
>     - **6-month (Q3 2026 - Q4 2026):** ship v1.0 with v26 plan-O1 + plan-O2 + plan-O3 in place. v26 ship-gate: Q4 W3 2026 (held from v25).
>     - **12-month (Q3 2026 - Q2 2027):** v1.5 (Q1 2027) with v26 call-source-tag primitive in all 5 daemons + v26 reversibility contract as a first-class architectural primitive. v26 v1.5 ship-gate: Q1 W4 2027 (held from v25).
>     - **24-month (Q3 2026 - Q2 2028):** v2.0 (Q4 2027) with v26 three-region-bifurcation support (U.S. defense, China sovereign, Europe Mistral/Forge) + v26 reversibility contract + v26 SIA-W+H port. v26 v2.0 ship-gate: Q4 W3 2027 (held from v25).
> 8. **v26 retractions of v25:** **2 partial retractions.** (a) v25 "Anthropic Mythos 5 is gated, $30K catch" is now v26 *lifted for Fable 5 (globally available July 1) and broadened for Mythos 5 (broader set of US critical-infrastructure organizations as of July 4)*. (b) v25 "closed-source frontier is export-controlled" is now v26 *politically-conditional, not export-controlled* — the v26 wedge sharpens correspondingly. **All other v25 holds.** v25 plan-A launch-blocker (Adversa + HackerNoon + Anthropic-Samsung + Sonnet 5 + Genesis AI Eno + Azure Linux 4.0 + Patchwork Labs Ava) *holds* in v26.
> 9. **v26 17-step marketing narrative:** v25 16-step holds. **v26 17th step: sovereign-trust + political-conditionality + reversibility.** See dan2-research-report.md v26 deltas preamble.
> 10. **v26 top 5 recommendations for somdipto:** (1) **Q3 W1: `toold` sovereign-trust audit (plan-O1, 1 day 1 engineer, *new in v26*)** — v26 launch-blocker upgrade, (2) **Q3 W2: `openclaw` + `toold` reversibility contract (plan-O2, 3 days 1 engineer, *new in v26*)** — v26 architecture upgrade, (3) **Q3 W1: v1.0 spec §13 sovereign-trust-and-reversibility section (plan-O3, 1 day copy, 1 engineer, *new in v26*)** — v26 copy deliverable, (4) **Q3 W2: Update v25 16-step → v26 17-step marketing narrative (1 day copy, 1 engineer, *new in v26*)** — v26 marketing deliverable, (5) **Q3 W1: Review and approve v26 6/12/24 plan revision (1 hour, somdipto)** — v26 plan-gate.
